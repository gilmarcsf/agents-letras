...
skipped; if this is the case, update the version of AGP to the latest stable
version as part of the AGP 9 migration. See the
...
### Step 3. Migrate Kotlin Multiplatform projects to the AGP 9 layout
...
### Step 4. Migrate to the new AGP DSL
...
### Step 5. Migrate kapt to KSP or legacy-kapt
